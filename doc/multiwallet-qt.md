...
In order to support loading of multiple wallets in highstakes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is highstakes.cpp.
...
Changes to highstakes.cpp
----------------------
highstakes.cpp is the entry point into highstakes-qt, and as such, will require some minor modifications to provide hooks for
