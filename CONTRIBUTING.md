Contributing to HighStakes
============================

The HighStakes project operates an open contributor model where anyone is
...
The following applies to code changes to the HighStakes project, and is not to be
confused with overall HighStakes Network Protocol consensus changes.

Whether a pull request is merged into HighStakes rests with the project merge
...
Patches that change HighStakes consensus rules are considerably more involved than
...
Where a patch set proposes to change the HighStakes consensus, it must have been
...
The project leader is the release manager for each HighStakes release.
