...
#   c) node1 mines 32 blocks, so now node 0 has 60001hisc, node 1 has 4250hisc, node2 has none.
#   d) node0 sends 601 hisc to node2, in two transactions (301 hisc, then 300 hisc).
