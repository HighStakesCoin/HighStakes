...
#ifndef HighStakes_ZHISCWALLET_H
#define HighStakes_ZHISCWALLET_H
...
public:
    CzHISCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHISC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHISC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //HighStakes_ZHISCWALLET_H
