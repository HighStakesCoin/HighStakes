...
/** Utility functions used by the HighStakes Qt UI.
 */
namespace GUIUtil
{
...
// Render HighStakes addresses in monospace font
...
// Parse "highstakes:" URI into recipient object, return true on successful parsing
