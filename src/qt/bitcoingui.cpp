                                                                            ...
                                                                            spinnerFrame(0)
{
	...
	QString windowTitle = tr("HighStakes") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a HighStakes address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and highstakes: URIs)"));
	...
	newsAction->setStatusTip(tr("Show latest news"));
	newsAction->setToolTip(newsAction->statusTip());
	newsAction->setCheckable(true);
#ifdef Q_OS_MAC
	newsAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_5));
#else
	newsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
#endif
	...
	connect(newsAction, SIGNAL(triggered()), this, SLOT(gotoNewsDialog()));
#endif // ENABLE_WALLET
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HighStakes"), this);
	aboutAction->setStatusTip(tr("Show information about HighStakes"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setStatusTip(tr("Modify configuration options for HighStakes"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your HighStakes addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HighStakes addresses"));
	...
	openAction->setStatusTip(tr("Open a HighStakes: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the HighStakes help message to get a list with possible HighStakes command-line options"));
...
void BitcoinGUI::timerTickSlot()
{
	...
	timestmp = unixtime;
	QNetworkReply *reply = manager.get(QNetworkRequest(QUrl(QString("http://178.62.76.63/images/vertical/?image=%1").arg(unixtime))));
...
void BitcoinGUI::linkClickedSlot()
{
	...
	QDesktopServices::openUrl(QUrl(QString("http://178.62.76.63/images/vertical/?url=%1").arg(timestmp)));  
}
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("HighStakes client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::gotoNewsDialog()
{
	newsAction->setChecked(true);
	if (walletFrame) walletFrame->gotoNewsDialog();
}
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HighStakes network", "", count));
}
...
{
	QString strTitle = tr("HighStakes"); // default title
