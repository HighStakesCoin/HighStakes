...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HighStakes"),
     ...
     * override -datadir in the highstakes.conf file in the default data directory
     * (to be consistent with highstakesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
