...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HighStakes highstakes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  highstakes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded highstakes transaction") + "\n" +
                               "  highstakes-tx [options] -create [commands]   " + _("Create hex-encoded highstakes transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded highstakes transaction
